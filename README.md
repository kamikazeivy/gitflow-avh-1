...
- To list, start, finish, or delete feature branches, use:
...
- To list, start, finish, or delete release branches, use:
...
- To list, start, finish, or delete hotfix branches, use:
...
- To list or start support branches, use:
